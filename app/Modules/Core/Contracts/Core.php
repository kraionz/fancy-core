...
abstract class Core
{
	...
	/**
	 * Whether the core data are loaded.
	 *
	 * @var boolean
	 */
	...
	/**
	 * Determine if a key exists in the data.
	 *
	 * @param  string  $key
	 *
	 * @return boolean
	...
	/**
	 * Set a specific key to a value in the data.
	 *
	...
	/**
	 * Save any changes done to the data.
	 *
	 * @return void
	 */
